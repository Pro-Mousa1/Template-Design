...
def-env activate-virtualenv [] {
    ...
    let virtual_env = '/home/mousa/PycharmProjects/afternoonRepeatCat/venv'
    let bin = 'bin'
    let path_sep = ':'
...
alias deactivate = source '/home/mousa/PycharmProjects/afternoonRepeatCat/venv/bin/deactivate.nu'
